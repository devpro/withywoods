...
namespace Withywoods.WebTesting.Rest
{
    ...
    {
        protected ResourceTestBase(HttpClient httpClient)
        {
        ...
        {
            return PostAsync(url, new StringContent(body, Encoding.UTF8, "application/json"), httpStatusCode);
        }
        ...
        {
            return PostAsync<T>(url, new StringContent(body, Encoding.UTF8, "application/json"), httpStatusCode);
        }
        ...
        {
            return PutAsync<T>(url, new StringContent(input, Encoding.UTF8, "application/json"), httpStatusCode);
        }
